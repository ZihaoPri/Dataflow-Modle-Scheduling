...
#define __NR_set_input_data (__X32_SYSCALL_BIT + 333)
#define __NR_get_input_datas (__X32_SYSCALL_BIT + 334)
#define __NR_set_output_data (__X32_SYSCALL_BIT + 335)
#define __NR_get_output_datas (__X32_SYSCALL_BIT + 336)
